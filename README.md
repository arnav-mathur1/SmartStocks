...
1. Install Python 3.12 and download the “test.py” file

2. Open the folder containing the file in an editor such as VSCode, then open a terminal in that folder
   
3. Create a virtual environment by running “python3 -m venv .venv” and activate it by running “source .venv/bin/activate” on macOS or Linux, or “.venv\Scripts\activate” on Windows 

4. Install the required libraries by running “python -m pip install yfinance pandas pygame-ce cmu-graphics==1.1.48 cmu-graphics-helpers==0.1.3” 
